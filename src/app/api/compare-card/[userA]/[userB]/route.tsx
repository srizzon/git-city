...
const TRASH_TALK: Record<Lang, { stomp: string[]; win: string[]; close: string[]; tie: string[] }> =
  {
    ...
    pt: {
      ...
      tie: ["PERFEITAMENTE EQUILIBRADO", "IMPOSSIVEL ESCOLHER", "REVANCHE OBRIGATORIA"],
    },
  };
  ...
  for (let r = 0; r < nRows; r++) {
    ...
    for (let c = 0; c < WCOLS; c++) {
      ...
      cells.push(
        <div
          key={c}
          style={{ width: WSIZE, height: WSIZE, backgroundColor: lit ? color : `${color}18` }}
        />,
      );
    }
    rows.push(
    ...
    >
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column" }}>
          <div style={{ display: "flex", fontSize: 22, color: cream, textTransform: "uppercase" }}>
      ...
      >
        ...
        {statRows.map((s) => (
          <div
            key={s.label}
            style={{ display: "flex", alignItems: "center", marginBottom: 6, width: 620 }}
          >
            <div
              style={{
                display: "flex",
      ...
      >
        <div style={{ display: "flex", flexDirection: "column", gap: 4 }}>
          <div style={{ display: "flex", fontSize: 26, color: cream, textTransform: "uppercase" }}>
            {summary}
          </div>
        </div>
        <div
          style={{ display: "flex", alignItems: "baseline", gap: 8, textTransform: "uppercase" }}
        >
