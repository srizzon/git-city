            ...
            return (
              <div className="relative hidden sm:block">
                <button
                  ...
                  className="flex items-center gap-1.5 border-[3px] border-border bg-bg/70 px-2.5 py-1 text-[10px] backdrop-blur-sm transition-colors hover:border-border-light"
                >
                  <span className={`${energyDotAnim} h-1.5 w-1.5 shrink-0 rounded-full ${energyDotColor}`} />
                  {codingCount > 0 ? (
                    <>
                      <span className="text-cream">{codingCount}</span>
                        ...
                        {displayDevs.map((dev) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <span className={`live-dot h-2 w-2 shrink-0 rounded-full ${isCreator ? "bg-[#fbbf24]" : "bg-[#4ade80]"}`} />
                            </button>
                          );
                        })}
                      </div>
              ...
              <div className="flex items-start justify-between">
                <Link href={`/dev/${authLogin}`} onClick={() => setMobileMenuOpen(false)} className="flex items-center gap-3">
                  {myBuilding?.avatar_url && (
                    <img src={myBuilding.avatar_url} alt="" className="h-12 w-12 rounded-full border-2" style={{ borderColor: theme.accent }} />
                  )}
                  <div>
                    <div className="flex items-center gap-2">
              ...
              {MILESTONE_MODE === "stars" ? (
                ...
                (() => {
                  ...
                  return (
                    ...
                    >
                      <div className="border-2 border-border bg-bg/80 px-4 py-3 backdrop-blur-sm transition-colors group-hover:border-(--hover-border)" style={{ "--hover-border": theme.accent } as React.CSSProperties}>
                ...
                (() => {
                  ...
                  return (
                    <div className="w-full max-w-sm">
                      <div className="border-2 border-border bg-bg/80 px-4 py-3 backdrop-blur-sm">
                        <div className="mb-2 flex items-baseline justify-between">
                          <span className="text-[9px] tracking-wider" style={{ color: theme.accent }}>
                            ROAD TO {label}
                          </span>
          ...
          <>
            ...
            >
              ...
              >
                ...
                {/* ── Scoreboard ── */}
                <div className="mx-4 border-2 border-border bg-bg-card">
                  {cmpRows.map((s, i) => (
                    <div
                      key={s.key}
                    ...
                    >
                      <span
                        className="w-18 text-right text-[11px] tabular-nums"
                      ...
                      <span
                        className="w-18 text-left text-[11px] tabular-nums"
                ...
                <div className="flex gap-2 px-4 pt-1 pb-5 sm:pb-4">
                  ...
                  <button
                    ...
                    className="btn-press flex-1 border-2border-border py-2 text-center text-[10px] text-cream transition-colors hover:border-border-light"
                  >
                    Close
                  </button>
                </div>
