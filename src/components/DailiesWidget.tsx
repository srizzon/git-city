  ...
  if (!open) {
    return (
      <button
        ...
        className={`pointer-events-auto btn-press fixed z-30 flex items-center gap-1.5 border-2 border-border bg-bg/80 px-2 py-1.5 text-[10px] backdrop-blur-sm transition-all hover:border-border-light ${isMobile ? "top-3 right-13" : "left-4 top-1/2 -translate-y-1/2"
          }`}
